...
export declare namespace Liquidation {
  export type LiquidationChanceStruct = {
  ...
  export type LiquidationChanceStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber,
    BigNumber,
...
export interface LiquidationInterface extends utils.Interface {
  functions: {
    ...
    "TARGET_HEALTH_FACTOR()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TARGET_HEALTH_FACTOR",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "RequestTransferMToken(address,address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RequestTransferMToken"): EventFragment;
...
export interface RequestTransferMTokenEventObject {
  from: string;
  to: string;
  amount: BigNumber;
}
export type RequestTransferMTokenEvent = TypedEvent<
  [string, string, BigNumber],
  RequestTransferMTokenEventObject
>;

export type RequestTransferMTokenEventFilter =
  TypedEventFilter<RequestTransferMTokenEvent>;
...
export interface Liquidation extends BaseContract {
  ...
  functions: {
    ...
    liquidate(
      ...
      _minYieldAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    ): Promise<Liquidation.LiquidationChanceStructOutput>;
  ...
  filters: {
    ...
    "MarketActivated(address,address,address)"(
      underlying?: PromiseOrValue<string> | null,
      mToken?: PromiseOrValue<string> | null,
    ...
    "RequestTransferMToken(address,address,uint256)"(
      from?: PromiseOrValue<string> | null,
      to?: PromiseOrValue<string> | null,
      amount?: null
    ): RequestTransferMTokenEventFilter;
    RequestTransferMToken(
      from?: PromiseOrValue<string> | null,
      to?: PromiseOrValue<string> | null,
      amount?: null
    ): RequestTransferMTokenEventFilter;
