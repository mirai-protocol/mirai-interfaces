...
export declare namespace Exec {
  export type MiraiBatchItemStruct = {
    allowError: PromiseOrValue<boolean>;
    proxyAddr: PromiseOrValue<string>;
    data: PromiseOrValue<BytesLike>;
  };

  export type MiraiBatchItemStructOutput = [boolean, string, string] & {
    allowError: boolean;
    proxyAddr: string;
    data: string;
  };
...
export interface ExecInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [Exec.MiraiBatchItemStruct[], PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
...
export interface Exec extends BaseContract {
  ...
  functions: {
    batchDispatch(
      items: Exec.MiraiBatchItemStruct[],
